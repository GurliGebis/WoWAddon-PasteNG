...
La["General"] = "Général"
La["It looks like you're pasting some slash commands to a chat channel. Would you like to execute them instead?"] = "Il semblerait que vous ayez collé des commandes ''/'' dans la fenêtre Coller. Souhaitez-vous les exécuter ?"
...
La["Bind a key to toggle the Paste window"] = "Paste 창의 표시를 전환할 때 사용할 단축키"
La["characters"] = "문자 수"
La["Clear"] = "지우기"
La["Command-V"] = "커맨드-V"
La["Config"] = "환경설정"
...
La["Edit font scale"] = "글꼴 크기"
La["for options"] = "옵션 열기"
La["General"] = "일반"
La["It looks like you're pasting some slash commands to a chat channel. Would you like to execute them instead?"] = "대화 채널에 슬래시 명령을 붙여넣기 하려고 있습니다. 대화 채널에 입력하는 대신 슬래시 명령을 실행하시겠습니까?"
La["Left Click"] = "왼쪽 클릭"
La["lines"] = "줄"
La["Minimap Icon"] = "미니맵 아이콘"
La["Open the configuration GUI"] = "환경설정 GUI 열기"
La["Paste"] = "붙여넣기"
La["Paste and Close"] = "붙여넣고 창 닫기"
La["Paste to:"] = "붙여넣기 할 곳:"
La["Profiles"] = "프로필"
La["Right Click"] = "오른쪽 클릭"
La["Scale the Paste window and all its contents"] = "Paste 창 크기 조정"
La["Scale the text font used in the Paste edit box"] = "Paste 창 글꼴 크기 조정"
La["Shift-Enter hotkey while typing in the edit box will Paste and Close"] = "Paste 창에 입력하는 동안 쉬프트-엔터를 입력하면 붙여넣고 닫습니다"
La["Shift-Enter to Paste"] = "쉬프트-엔터로 붙여넣기"
La["Show"] = "열기"
La["Show/Hide the Paste window"] = "Paste 창 상태 전환"
La["Strip Empty Lines"] = "빈 줄 제거하기"
La["Strip empty lines (those containing only whitespace) from the output. Note some channels automatically drop fully empty lines."] = "공백 문자만 있는 빈 줄을 출력에서 제거합니다. 몇몇 대화 채널은 기본으로 빈 줄을 제거합니다."
La["Toggle debugging output"] = "디버그 출력 토글"
La["to toggle window"] = "Paste 창 토글"
La["Trim Whitespace"] = "공백 제거"
La["Trim whitespace from the beginning and end of lines in the output."] = "처음부터 끝까지 출력에서 공백 문자를 제거함"
La["Use %s to paste the clipboard into this box"] = "%s을 눌러 이 곳에 붙여 넣으십시오"
La["Window Scale"] = "창 크기"
La["You must select a whisper target!"] = "귓속말을 할 상대를 정해야합니다"
